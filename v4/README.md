...
A Retrieval-Augmented Generation (RAG) system that answers questions about the Bitcoin and Ethereum whitepapers using LangChain, Pinecone, and OpenAI. v2 adds a Gradio chat interface. v3 adds RAGAS evaluation. v4 improves retrieval with multi-query and FlashRank reranking, and uses RAGAS to show a before/after comparison.

[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/patriciarrs/Rag-finalproject/blob/main/v4/RAG_FinalProject.ipynb)
...
- **Before/after comparison** — RAGAS scores for both strategies printed side by side with a delta column
...
| Retrieval | Multi-query + FlashRank reranking |
